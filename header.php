...
$defaultTexts = [
    1 => 'Arch Linux — це дистрибутив, орієнтований на досвідчених користувачів...',
    2 => "NixOS — унікальний дистрибутив...",
    3 => "Головна сторінка",
    4 => "Linux Mint — це дистрибутив...", 
    5 => "Ubuntu — один із найпопулярніших дистрибутивів...",
    6 => "Fedora — дистрибутив, який підтримується спільнотою..."
];
